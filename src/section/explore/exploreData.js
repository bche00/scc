export const exploreLocations = {
  ...
  // 2층 교실
    ...
    "책상을 살펴본다.": {
    image: "/asset/img/class_room.png",
    description: "책상 위엔 네임펜으로 그려진 낙서들과, 급식표가 붙어있다..",
    choices: [
      { text: "▶ 책상 사물함을 살펴본다.", goTo: "책상 사물함을 살펴본다."},
      { text: "▶ 조사한다.", triggersEvent: true},
      { text: "▶ 돌아간다. ", goTo: "교실" }
    ],
  },
    "책상 사물함을 살펴본다.": {
    image: "/asset/img/class_room.png",
    description: "두 학생의 필담이 빼곡히 적혀있는 노트가 있다.|[학생 A]\n너 그 얘기 들었어?\n작년 섬 체험학습 때 실종됐던 그 선배….|[학생 B]\n아… 우리 교실 쓰셨댔지….\n 그 동아리에서 단체로 마지막 날 밤에 담력시험이랍시고 몰래 산에 갔었다며.|[학생 A]\nㅇㅇㅇ 근데 진짜 소름인 게\n산에서 내려올 때도 집으로 돌아갈 때도 인원 다 세고 이상 없었다며?|[학생 B]\n뭐?\n근데… 결국 거기서 발견됐었잖아.|[학생 A]\n그니까. 그럼 누가 같이 돌아왔던 거야?|[학생 B]\n몰라… 미친, 그래서 학교고 애들이고 다 쉬쉬한 건가?|[학생 A]\n그런가 봐.\n아! 종 쳤다… 밥 먹으러 가면서 계속 얘기해.|…글은 여기서 끊겨있다.",
    choices: [
      { text: "▶ 돌아간다. ", goTo: "책상을 살펴본다." }
    ],
  },
    "사물함을 살펴본다. ": {
    image: "/asset/img/class_room.png",
